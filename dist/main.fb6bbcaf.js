...
var indicators = _toConsumableArray(document.querySelectorAll('.indicator')); // console.log(slider, buttons, reviews, indicators);


var isMoving;
var currentIndex = 1;

var showActiveIndicator = function showActiveIndicator() {
  indicators.forEach(function (ind) {
    return ind.classList.remove('active');
  });
  var activeIndicator;
...
var handleIndicatorClick = function handleIndicatorClick(e) {
  if (isMoving) return;
  isMoving = true;
